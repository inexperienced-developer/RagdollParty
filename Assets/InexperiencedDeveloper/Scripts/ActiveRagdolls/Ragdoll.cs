...
namespace InexperiencedDeveloper.ActiveRagdoll
{
    public class Ragdoll : MonoBehaviour
    {
        ...
        private void GetSegments()
        {
            ...
            Debug.Log($"Found {BodyPartsFound} body parts");
            Debug.LogWarning($"TODO: Collision set up for body parts");
        ...
        private BodySegment InitializeSegment(Transform t)
        {
            ...
            //FOR DEBUG ONLY
            if(segment.Collider == null) Debug.LogError($"{t.name} is missing Collider");
            if(segment.Rigidbody == null) Debug.LogError($"{t.name} is missing Rigidbody");
            BodyPartsFound++;
            print(t.name);
