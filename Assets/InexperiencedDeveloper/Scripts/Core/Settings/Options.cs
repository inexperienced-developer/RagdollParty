...
namespace InexperiencedDeveloper.Core.Settings
{
    public static class Options
    {
        ...
        {
            Debug.LogWarning("TODO: Implement brightness adjustment");
        }

        private static void ApplyCameraEffects()
        {
            Debug.LogWarning("TODO: Implement post process adjustment");
        }

        private static void ApplyAudioMaster()
        {
            Debug.LogWarning("TODO: Implement master audio adjustment");
        }

        private static void ApplyAudioFX()
        {
            Debug.LogWarning("TODO: Implement FX audio adjustment");
        }

        private static void ApplyAudioMusic()
        {
            Debug.LogWarning("TODO: Implement music audio adjustment");
        }

        private static void ApplyAudioVoice()
        {
            Debug.LogWarning("TODO: Implement voice audio adjustment");
        }

        private static void ApplyMouseSettings()
        {
            Debug.LogWarning("TODO: Implement mouse settings");
        }
        ...
        {
            Debug.LogWarning("TODO: Implement Camera settings");
        }
